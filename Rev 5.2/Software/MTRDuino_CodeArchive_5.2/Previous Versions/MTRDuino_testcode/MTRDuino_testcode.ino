      ...
      while(waiting==true){        //Run loop to set unit status as long as serial connection exists
        ...
        switch (byteRead){   
          ...
          case  83 : //if user enters 'S', display logger "Status"
            ...
            Serial.println("  (If needed, must change Sample Interval or Measurements Per Sample in code)");
            Serial.print("SD Card Status:    ");
            SDCardCheck();
            Serial.print("Thermistor Value:    ");
            Serial.println(therm_resistance,2);
            Serial.println();
            waiting=false;
            break;
          case  65 : //'A'
            Serial.println("Enter Desired Alarm Date:");
            ...
            if(checkdigit==true){
              Serial.println("Enter Desired Alarm Time:");
