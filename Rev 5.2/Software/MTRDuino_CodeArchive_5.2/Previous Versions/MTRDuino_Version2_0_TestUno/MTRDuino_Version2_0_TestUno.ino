...
void setup () {    
    ...
    ADCSetup();  //Set gain to 8 on ADC (more precise)
    float adcVal = 0;
    ...
    therm_voltage = adcVal * VREF / 32768;  //voltage is adc reading * reference voltage / adc possible values / adc gain
    //int refRes = 10000;
...
void ADCSetup(){
  ...
  Wire.write(B10001101); //set ADC gain to 8, 15 Samples per Second (16-bit Resolution)
